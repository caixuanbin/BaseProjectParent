...
public class DataCheckUtils {
    public static void  checkTYPT(String filePath){
        ...
        try {
            ...
            pWriter = new PrintWriter(new FileWriter(file.substring(0,file.lastIndexOf(".csv"))+"_result.txt"),true);
            String line = null;
            int no=1;
            sb.append(filePath+" 解析内容结果如下：\n");
            //检验 T_QYMP_114P 商家表
            if(file.contains("t_qymp_114p")&&file.contains(".csv")) {
                while ((line = bReader.readLine()) != null) {
                    String[] lineArray = StringUtils.splitPreserveAllTokens(line, "|");
                    if(lineArray.length!=98){
                        sb.append("第"+no+"行 有"+lineArray.length+"列与实际要求的98列不相符，该列内容如下："+line+"\n");
                                no++;
                                continue;
                    }
            ...
            else if(file.contains("t_qymp_114p_del")&&file.contains(".csv")) {
                while ((line = bReader.readLine()) != null) {
                    String[] lineArray = StringUtils.splitPreserveAllTokens(line, "|");
                    if(lineArray.length!=95){
                        sb.append("第"+no+"行 有"+lineArray.length+"列与实际要求的95列不相符，该列内容如下："+line+"\n");
                        no++;
                        continue;
                    }
                    for(int i=0;i<lineArray.length;i++){
            ...
            //t_qymp_114_temp 商家临时表
            else if(file.contains("t_qymp_114_temp")&&file.contains(".csv")) {
                while ((line = bReader.readLine()) != null) {
                    String[] lineArray = StringUtils.splitPreserveAllTokens(line, "|");
                    if(lineArray.length!=99){
                        sb.append("第"+no+"行 有"+lineArray.length+"列与实际要求的99列不相符，该列内容如下："+line+"\n");
                        no++;
                        continue;
                    }
                    for(int i=0;i<lineArray.length;i++){
            ...
            else if(file.contains("t_qymp_114p_temp_extra")&&file.contains(".csv")) {
                while ((line = bReader.readLine()) != null) {
                    String[] lineArray = StringUtils.splitPreserveAllTokens(line, "|");
                    if(lineArray.length!=28){
                        sb.append("第"+no+"行 有"+lineArray.length+"列与实际要求的28列不相符，该列内容如下："+line+"\n");
                        no++;
                        continue;
                    }
                    for(int i=0;i<lineArray.length;i++){
            ...
            else if(file.contains("t_qymp_114p_temp_extra_del")&&file.contains(".csv")) {
                while ((line = bReader.readLine()) != null) {
                    String[] lineArray = StringUtils.splitPreserveAllTokens(line, "|");
                    if(lineArray.length!=28){
                        sb.append("第"+no+"行 有"+lineArray.length+"列与实际要求的28列不相符，该列内容如下："+line+"\n");
            ...
            else if(file.contains("t_qymp_114p_temp_status_change")&&file.contains(".csv")) {
                while ((line = bReader.readLine()) != null) {
                    String[] lineArray = StringUtils.splitPreserveAllTokens(line, "|");
                    if(lineArray.length!=17){
                        sb.append("第"+no+"行 有"+lineArray.length+"列与实际要求的17列不相符，该列内容如下："+line+"\n");
                        no++;
                        continue;
                    }
                    for(int i=0;i<lineArray.length;i++){
            ...
            //T_QYMP_AUDIT_DATA_SEND_COOPERATOR行业版商家审核结果发送合作商表
                ...
                while ((line = bReader.readLine()) != null) {
                    ...
                    if(lineArray.length!=10){
                        sb.append("第"+no+"行 有"+lineArray.length+"列与实际要求的10列不相符，该列内容如下："+line+"\n");
                        no++;
                        continue;
                    }
                    for(int i=0;i<lineArray.length;i++){
            ...
            else if(file.contains("t_qymp_industry_data_send_icrm")&&file.contains(".csv")) {
                while ((line = bReader.readLine()) != null) {
                    String[] lineArray = StringUtils.splitPreserveAllTokens(line, "|");
                    if(lineArray.length!=6){
                        sb.append("第"+no+"行 有"+lineArray.length+"列与实际要求的6列不相符，该列内容如下："+line+"\n");
                        no++;
                        continue;
                    }
                    for(int i=0;i<lineArray.length;i++){
            ...
            else if(file.contains("t_qymp_industry_detail")&&file.contains(".csv")) {
                while ((line = bReader.readLine()) != null) {
                    String[] lineArray = StringUtils.splitPreserveAllTokens(line, "|");
                    if(lineArray.length!=6){
                        sb.append("第"+no+"行 有"+lineArray.length+"列与实际要求的6列不相符，该列内容如下："+line+"\n");
            ...
            //T_QYMP_JOBS行业工单表
            else if(file.contains("t_qymp_jobs")&&file.contains(".csv")) {
                while ((line = bReader.readLine()) != null) {
                    String[] lineArray = StringUtils.splitPreserveAllTokens(line, "|");
                    if(lineArray.length!=20){
                        sb.append("第"+no+"行 有"+lineArray.length+"列与实际要求的20列不相符，该列内容如下："+line+"\n");
                        no++;
                        continue;
                    }
                    for(int i=0;i<lineArray.length;i++){
            ...
            else if(file.contains("t_qymp_jobs_del")&&file.contains(".csv")) {
                while ((line = bReader.readLine()) != null) {
                    String[] lineArray = StringUtils.splitPreserveAllTokens(line, "|");
                    if(lineArray.length!=22){
                        sb.append("第"+no+"行 有"+lineArray.length+"列与实际要求的22列不相符，该列内容如下："+line+"\n");
                        no++;
                        continue;
                    }
                    for(int i=0;i<lineArray.length;i++){
            ...
            else if(file.contains("t_qymp_jobs_state_change")&&file.contains(".csv")) {
                while ((line = bReader.readLine()) != null) {
                    String[] lineArray = StringUtils.splitPreserveAllTokens(line, "|");
                    if(lineArray.length!=16){
                        sb.append("第"+no+"行 有"+lineArray.length+"列与实际要求的16列不相符，该列内容如下："+line+"\n");
                        no++;
                        continue;
                    }
                    for(int i=0;i<lineArray.length;i++){
            ...
            else if(file.contains("t_qymp_report_login")&&file.contains(".csv")) {
                while ((line = bReader.readLine()) != null) {
                    String[] lineArray = StringUtils.splitPreserveAllTokens(line, "|");
                    if(lineArray.length!=4){
                        sb.append("第"+no+"行 有"+lineArray.length+"列与实际要求的4列不相符，该列内容如下："+line+"\n");
                        no++;
                        continue;
                    }
                    for(int i=0;i<lineArray.length;i++){
            ...
            else if(file.contains("t_qymp_send_message_record")&&file.contains(".csv")) {
                while ((line = bReader.readLine()) != null) {
                    String[] lineArray = StringUtils.splitPreserveAllTokens(line, "|");
                    if(lineArray.length!=12){
                        sb.append("第"+no+"行 有"+lineArray.length+"列与实际要求的12列不相符，该列内容如下："+line+"\n");
                        no++;
                        continue;
                    }
                    for(int i=0;i<lineArray.length;i++){
            ...
            //T_QYMP_SMS短信内容表
            else if(file.contains("t_qymp_sms")&&file.contains(".csv")) {
                while ((line = bReader.readLine()) != null) {
                    String[] lineArray = StringUtils.splitPreserveAllTokens(line, "|");
                    if(lineArray.length!=12){
                        sb.append("第"+no+"行 有"+lineArray.length+"列与实际要求的12列不相符，该列内容如下："+line+"\n");
            ...
            else if(file.contains("t_qymp_sms_template")&&file.contains(".csv")) {
                while ((line = bReader.readLine()) != null) {
                    String[] lineArray = StringUtils.splitPreserveAllTokens(line, "|");
                    if(lineArray.length!=14){
                        sb.append("第"+no+"行 有"+lineArray.length+"列与实际要求的14列不相符，该列内容如下："+line+"\n");
                        no++;
                        continue;
                    }
                    for(int i=0;i<lineArray.length;i++){
            ...
            else if(file.contains("t_qymp_web_build_data")&&file.contains(".csv")) {
                while ((line = bReader.readLine()) != null) {
                    String[] lineArray = StringUtils.splitPreserveAllTokens(line, "|");
                    if(lineArray.length!=12){
                        sb.append("第"+no+"行 有"+lineArray.length+"列与实际要求的14列不相符，该列内容如下："+line+"\n");
            ...
            else if(file.contains("t_qymp_web_build_data_second")&&file.contains(".csv")) {
                while ((line = bReader.readLine()) != null) {
                    String[] lineArray = StringUtils.splitPreserveAllTokens(line, "|");
                    if(lineArray.length!=12){
                        sb.append("第"+no+"行 有"+lineArray.length+"列与实际要求的14列不相符，该列内容如下："+line+"\n");
            ...
            //T_QYMP_WEB_BUILD_DATA_SECOND_SEND_ID并行施工接口需要生成二次下发数据的id表
                ...
                while ((line = bReader.readLine()) != null) {
                    ...
                    if(lineArray.length!=9){
                        sb.append("第"+no+"行 有"+lineArray.length+"列与实际要求的9列不相符，该列内容如下："+line+"\n");
                        no++;
                        continue;
                    }
                    for(int i=0;i<lineArray.length;i++){
            ...
            System.out.println("结束解析文件："+filePath);
        } catch (IOException e) {
            e.printStackTrace();
        }finally {
            try {
